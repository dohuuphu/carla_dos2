...
from leaderboard.autoagents import autonomous_agent, autonomous_agent
from leaderboard_nav_planner import PIDController, RoutePlanner, interpolate_trajectory, extrapolate_waypoint_route
...
class AutoPilot(autonomous_agent.AutonomousAgent):
  ...
  def setup(self, path_to_conf_file, route_index=None):
    ...
    # Configuration
    self.visualize = 1 #int(os.environ.get('DEBUG_CHALLENGE', 0))
  ...
  def _init(self, hd_map):
    ...
    # tr_list = [[item[0].location.x, item[0].location.y] for item in self._global_plan_world_coord]
      
    # np.save("/media/chiehchiyang/GM7000/leaderboard2.0/leaderboard/team_code//route/route.pkl",
    #     np.array(tr_list))
