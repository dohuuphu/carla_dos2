...
from srunner.scenarios.cut_in_stationary_object import CuttingInStationaryObject
from srunner.scenarios.cut_in_active_object import CuttingInActiveObject
from srunner.scenarios.occluded_crossing_junction import OccludedCrossingJunction
from srunner.scenarios.occluded_left_crossing_junction import OccludedLeftCrossingJunction
...
NUMBER_CLASS_TRANSLATION = {
    ...
    "DOS_01": CuttingInStationaryObject,
    "DOS_02": CuttingInActiveObject,
    "DOS_03": OccludedLeftCrossingJunction,
    "DOS_04": OccludedCrossingJunction,
}
