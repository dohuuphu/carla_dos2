...
def main():
    ...
    parser.add_argument('--routes',
                        ...
                        default='/mnt/HDD1/phudh/course/calar/IDS_s24/HW0/DOS/DOS_benchmark/DOS_01_town05.xml')
    parser.add_argument('--scenarios',
                        help='Name of the scenario annotation file to be mixed with the route.',
                        default='/mnt/HDD1/phudh/course/calar/IDS_s24/HW0/DOS/DOS_benchmark/DOS_01_town05.json')
    ...
    parser.add_argument("-a", "--agent", type=str, help="Path to Agent's py file to evaluate", default='/mnt/HDD1/phudh/course/calar/IDS_s24/HW0/agents/TFPP/longest6_agent.py')
    ...
    save_path = '/mnt/HDD1/phudh/course/calar/IDS_s24/HW0/results/DOS/test'
